...
public class principal {
    public static void main(String[] args) throws IOException {
        ...
        MenuPrincipal relleno = new MenuPrincipal();
        Scanner lectura = new Scanner(System.in);

        while (true) {
            try {
                relleno.menuEnPantalla();
                ...
                APITAKE consulta = new APITAKE();
                Moneda representation = consulta.monedaEnApi(moneda1, moneda2, cantidad);
                ...
                CrearFile archivoJson = new CrearFile();
        ...
        CrearFile archivoRegistro = new CrearFile();
